            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="header-page-locator">
                        <ul>
                            <li><a href="{{ url('/') }}">Home <i class="fa fa-compress" aria-hidden="true"></i> </a> Blog</li>
                        </ul>
                    </div>
                    ...
                    <div class="header-page-subtitle">
                        <p>Read the full blog post below.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="single-image">
                    <img src="{{ $blog->main_img ? asset($blog->main_img) : asset('assets/frontend/images/single/1.jpg') }}" alt="Blog photo">
                </div>
                <h3><a href="#">{{ $blog->main_head }}</a></h3>
                <p>{!! $blog->main_desc !!}</p>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="popular-post-img">
                                    <a href="{{ route('blog.show', $item->slug) }}">
                                        <img src="{{ $item->main_img ? asset($item->main_img) : asset('assets/frontend/images/single/2.jpg') }}" alt="Blog photo">
                                    </a>
                                </div>
                                <h4><a href="{{ route('blog.show', $item->slug) }}">{{ $item->main_head }}</a></h4>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="sidebar-area">
                    ...
                    <div class="recent-post-area hot-news">
                        <h3 class="title-bg">Recent Blogs</h3>
                        <ul class="news-post">
                                        ...
                                        <div class="item-post">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 paddimg-right-none">
                                                    <a href="{{ route('blog.show', $item->slug) }}"><img src="{{ $item->main_img ? asset($item->main_img) : asset('assets/frontend/images/popular/1.jpg') }}" alt="" title="Blog image" /></a>
                                                </div>
                    ...
                    <div class="trending-post-area">
                        <h3 class="title-bg">Trending Blogs</h3>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <ul>
                                    @foreach($trendingBlogs as $item)
                                    <li>
                                        <a href="{{ route('blog.show', $item->slug) }}" class="hvr-bounce-to-right team-btn">The team</a><br/>
                                        <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> {{ $item->created_at ? $item->created_at->format('M d, Y') : '' }}</span>
                                        <h4><a href="{{ route('blog.show', $item->slug) }}">{{ $item->main_head }}</a></h4>
