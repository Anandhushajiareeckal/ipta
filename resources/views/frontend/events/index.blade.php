                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="header-page-subtitle">
                            <p>Browse our latest events and updates.</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="blog-image">
                                        <a href="{{ route('events.show', $item->slug) }}">
                                            ...
                                            <img src="{{ $item->main_img ? asset($item->main_img) : asset('assets/frontend/images/blog/default.jpg') }}" alt="Event photo">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <a href="{{ route('events.show', $item->slug) }}" class="more">Read More <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
