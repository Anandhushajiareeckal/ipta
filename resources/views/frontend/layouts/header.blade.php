            ...
            <div class="row">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    ...
                    <div class="main-menu navbar-collapse collapse">
                        <nav>
                            <ul>
                                <li><a href="index.html" class="has dropdown-toggle">Home <i class="fa fa-chevron-down"
                                            aria-hidden="true"></i></a>
                                    <ul class="sub-menu">
                                ...
                                <li><a href="#" class="has">Mega Menu <i class="fa fa-chevron-down"
                                            aria-hidden="true"></i></a>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <a href="blog-single.html"><img src="images/category/1.jpg"
                                                            alt=""></a>
                                                    <h3> <a href="blog-single.html">Holiday Money: The Ultimate Guide to
                                                            Buying</a></h3>
                                                    <p>Nulla ullamcorper orci metus, eu imperdiet quam is a dapibus
                                                        ac...</p>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <a href="blog-single.html"><img src="images/category/2.jpg"
                                                            alt=""></a>
                                                    <h3> <a href="blog-single.html">The Exhibition Bankasy Doesn’t Want
                                                            You to See </a></h3>
                                                    <p>Nulla ullamcorper orci metus, eu imperdiet quam is a dapibus
                                                        ac...</p>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <a href="blog-single.html"><img src="images/category/5.jpg"
                                                            alt=""></a>
                                                    <h3> <a href="blog-single.html">How to End Boom And Bust: Make Cash
                                                            Illegal </a></h3>
                                                    <p>Nulla ullamcorper orci metus, eu imperdiet quam is a dapibus
                                                        ac...</p>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <a href="blog-single.html"><img src="images/category/4.jpg"
                                                            alt=""></a>
                                                    <h3> <a href="blog-single.html">Quiz: Turner Prize Nominee or Load
                                                            of Old Rubbish? </a></h3>
                                                    <p>Nulla ullamcorper orci metus, eu imperdiet quam is a dapibus
                                                        ac...</p>
                                                </div>
                                ...
                                <li><a href="#" class="has">Pages <i class="fa fa-chevron-down"
                                            aria-hidden="true"></i></a>
                                    <ul class="sub-menu">
                                        <li><a href="about.html">About</a></li>
                                        <li class="has"><a href="#">Blog <i class="fa fa-angle-right"
                                                    aria-hidden="true"></i></a>
                                            <ul>
                                        ...
                                        <li><a href="#">Category <i class="fa fa-angle-right"
                                                    aria-hidden="true"></i></a>
                                            <ul>
                                        ...
                                        <li><a href="#">Gallery<i class="fa fa-angle-right"
                                                    aria-hidden="true"></i></a>
                                            <ul>
                                        ...
                                        <li><a href="#">Author <i class="fa fa-angle-right"
                                                    aria-hidden="true"></i></a>
                                            <ul>
