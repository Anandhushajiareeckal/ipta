            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="header-page-locator">
                        <ul>
                            <li><a href="{{ url('/') }}">Home <i class="fa fa-compress" aria-hidden="true"></i> </a> Little</li>
                        </ul>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="single-image">
                    <img src="{{ $little->main_img ? asset($little->main_img) : asset('assets/frontend/images/single/1.jpg') }}" alt="Little photo">
                </div>
                <h3><a href="#">{{ $little->main_head }}</a></h3>
                <p>{!! $little->main_desc !!}</p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 life-style">
                            ...
                            <span class="date">
                                ...
                                {{ $little->created_at ? $little->created_at->format('M d, Y') : '' }}
                            </span>
                        </div>
                    </div>
                </div>
                <div class="like-section">
                    ...
                    <div class="row">
                        @foreach($relatedLittles as $item)
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="popular-post-img">
                                    <a href="{{ route('little.show', $item->slug) }}">
                                        <img src="{{ $item->main_img ? asset($item->main_img) : asset('assets/frontend/images/single/2.jpg') }}" alt="Little photo">
                                    </a>
                                </div>
                                <h4><a href="{{ route('little.show', $item->slug) }}">{{ $item->main_head }}</a></h4>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="sidebar-area">
                    ...
                    <div class="recent-post-area hot-news">
                        <h3 class="title-bg">Recent Littles</h3>
                        <ul class="news-post">
                            @foreach($recentLittles as $item)
                            <li>
                                <div class="row">
                                        ...
                                        <div class="item-post">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 paddimg-right-none">
                                                    <a href="{{ route('little.show', $item->slug) }}"><img src="{{ $item->main_img ? asset($item->main_img) : asset('assets/frontend/images/popular/1.jpg') }}" alt="" title="Little image" /></a>
                                                </div>
                    ...
                    <div class="trending-post-area">
                        <h3 class="title-bg">Trending Littles</h3>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <ul>
                                    @foreach($trendingLittles as $item)
                                    <li>
                                        <a href="{{ route('little.show', $item->slug) }}" class="hvr-bounce-to-right team-btn">The team</a><br/>
                                        <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> {{ $item->created_at ? $item->created_at->format('M d, Y') : '' }}</span>
                                        <h4><a href="{{ route('little.show', $item->slug) }}">{{ $item->main_head }}</a></h4>
