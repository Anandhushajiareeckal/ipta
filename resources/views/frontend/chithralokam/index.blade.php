...
@section('content')
    <div class="blog-page-area gellary-area-main gallery-page gellary-area">
        <div class="container">
            <div class="row">
                @foreach ($chithralokams as $chithralokam)
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div id="news-Carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="single-gellary">
                                                <div class="image">
                                                    @if(isset($chithralokam->images[0]))
                                                        <img src="{{ asset($chithralokam->images[0]) }}" alt="{{ $chithralokam->title }}">
                                                    @else
                                                        <img src="{{ asset('assets/frontend/images/no-image.jpg') }}" alt="No Image">
                                                    @endif
                                                    <div class="overley">
                                                        <ul>
                                                            <li><a href="{{ route('chithralokam.show', $chithralokam->slug) }}"><i class="fa fa-link"
                                ...
                                @foreach ( collect($chithralokam->images)->take(5) as $image )
                                <div class="item">
                                    <ul>
                                        <li>
                                            <div class="single-gellary">
                                ...
                                <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"> </i> {{ $chithralokam->created_at->format('M d, Y') }}</span>
                                <h3><a href="{{ route('chithralokam.show', $chithralokam->slug) }}">{{ $chithralokam->title }}</a></h3>
                                <a href="{{ route('chithralokam.show', $chithralokam->slug) }}" class="more">View More <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                    <div class="pagination-area">
                        {{ $chithralokams->links('pagination::bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
