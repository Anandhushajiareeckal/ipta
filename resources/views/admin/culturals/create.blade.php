...
@section('title') {{ __('Add Cultural') }} @endsection
...
<div class="row mt-4">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.culturals.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-success">Create Cultural</button>
                </form>
            </div>
        </div>
    </div>
