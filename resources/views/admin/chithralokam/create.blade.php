...
@section('title') {{ __('Add Chithralokam') }} @endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.chithralokam.store') }}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="mb-4 row">
                        <label for="title" class="col-sm-3 col-form-label">{{ __('Title') }}<span style="color: red;">*</span></label>
                        <div class="col-sm-9">
                            <input id="title" name="title" type="text" class="form-control" placeholder="Enter Chithralokam Title" value="{{ old('title') }}">
