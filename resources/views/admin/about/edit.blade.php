                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.about.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                @if (!empty($data->banner_image))
                                    <img src="{{ asset('storage/' . $data->banner_image) }}" alt="Banner" class="img-thumbnail mb-2" width="100">
                                @endif
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="banner_head" class="form-control" value="{{ old('banner_head', @$data->banner_head) }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="main_head" class="form-control" value="{{ old('main_head', @$data->main_head) }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                @if (!empty($data->main_image))
                                    <img src="{{ asset('storage/' . $data->main_image) }}" alt="Main Image" class="img-thumbnail mb-2" width="100">
                                @endif
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                @if (!empty($data->image_2))
                                    <img src="{{ asset('storage/' . $data->image_2) }}" alt="Image 2" class="img-thumbnail mb-2" width="100">
                                @endif
                        ...
                        <div class="mb-4 row">
                            <label class="col-sm-3 col-form-label">Our</label>
                            <div class="col-sm-9">
                                <input type="text" name="our" class="form-control" value="{{ old('our', @$data->our) }}">
                            </div>
                        </div>

                        <div class="mb-4 row">
                            <label class="col-sm-3 col-form-label">Head 2</label>
                            <div class="col-sm-9">
                                <input type="text" name="head_2" class="form-control" value="{{ old('head_2', @$data->head_2) }}">
                            </div>
                        </div>
                        ...
                        @for ($i = 1; $i <= 3; $i++)
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="sub_head_{{ $i }}" class="form-control" value="{{ old('sub_head_'.$i, @$data->{'sub_head_'.$i}) }}">
                                </div>
                            </div>
                            <div class="mb-4 row">
                        ...
                        @for ($i = 1; $i <= 4; $i++)
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="rank_value_{{ $i }}" class="form-control" value="{{ old('rank_value_'.$i, @$data->{'rank_value_'.$i}) }}">
                                </div>
                            </div>
                            <div class="mb-4 row">
                                <label class="col-sm-3 col-form-label">Rank Text {{ $i }}</label>
                                <div class="col-sm-9">
                                    <input type="text" name="rank_text_{{ $i }}" class="form-control" value="{{ old('rank_text_'.$i, @$data->{'rank_text_'.$i}) }}">
                                </div>
                            </div>
                        @endfor
