...
@section('title') Add Jana Sangeetham @endsection
@section('content')
<div class="row mt-4">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.jana-sangeetham.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-success">Create Jana Sangeetham</button>
                </form>
            </div>
        </div>
    </div>
