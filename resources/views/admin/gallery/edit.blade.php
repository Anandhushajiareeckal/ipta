...
@section('title') {{ __('Edit Gallery') }} @endsection
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.gallery.update', $gallery->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-9">
                            <input id="title" name="title" type="text" class="form-control" placeholder="Enter Gallery Title" value="{{ old('title', $gallery->title) }}">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-9">
                            <input id="slug" name="slug" type="text" class="form-control" value="{{ $gallery->slug }}" readonly>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-9">
                            ...
                            <a href="{{ route('admin.gallery.index') }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
                        </div>
                    </div>
                </form>
            </div>
