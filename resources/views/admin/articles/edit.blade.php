            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.articles.update', $article->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-9">
                            <input id="main_head" name="main_head" type="text" class="form-control" placeholder="Enter Main Heading" value="{{ old('main_head', $article->main_head) }}">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @if($article->main_img)
                                <div class="mt-2">
                                    <img src="{{ asset($article->main_img) }}" alt="Current Image" width="100">
                                </div>
                            @endif
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-9">
                            <textarea id="main_desc" name="main_desc" class="form-control summernote" rows="4" placeholder="Enter Main Description">{{ old('main_desc', $article->main_desc) }}</textarea>
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-9">
                            <textarea id="banner_desc" name="banner_desc" class="form-control" rows="2" placeholder="Enter Banner Description">{{ old('banner_desc', $article->banner_desc) }}</textarea>
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-9">
                            <input id="slug" name="slug" type="text" class="form-control" value="{{ $article->slug }}" readonly>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-9">
                            ...
                            <a href="{{ route('admin.articles.index') }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
                        </div>
                    </div>
                </form>
            </div>
