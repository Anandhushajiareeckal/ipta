...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('/storage/') }}">

    <!-- owl.carousel css -->
    <link rel="stylesheet" href="{{ asset('assets/backend/assets/libs/owl.carousel/assets/owl.carousel.min.css') }}">

    <link rel="stylesheet" href="{{ asset('assets/backend/assets/libs/owl.carousel/assets/owl.theme.default.min.css') }}">
    @notify_css
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box" style="background-color:#060332 !important ">
                        <a class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="{{ asset('/storage/') }}" alt="" height="30">
                            </span>
                            <span class="logo-lg">
                               <img src="{{asset('assets/backend/assets/images/kv-logo-sm.png')}}" alt="" height="50">
                                <!-- <img src="{{ asset('/storage/') }}" alt="" height="50"> -->
                            </span>
                        </a>

                        <a class="logo logo-light">
                            <span class="logo-sm">
                                <img src="{{asset('assets/backend/assets/images/kv-logo-sm.png')}}" alt="" height="30">
                                 <!-- <img src="{{ asset('/storage/') }}" alt="" height="30"> -->
                            </span>
                            <span class="logo-lg">
                                  <!-- <img src="{{asset('assets/backend/assets/images/kv-logo-sm.png')}}" alt="" height="30"> -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div>
                                                <img src="{{ asset('assets/backend/assets/images/megamenu-img.png') }}"
                    ...
                    <div class="dropdown d-inline-block">
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="en">
                                <img src="{{ asset('assets/backend/assets/images/flags/us.jpg') }}" alt="user-image" class="me-1"
                                    height="12"> <span class="align-middle">English</span>
                            </a>
                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp">
                                <img src="{{ asset('assets/backend/assets/images/flags/spain.jpg') }}" alt="user-image"
                                    class="me-1" height="12"> <span class="align-middle">Spanish</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                                <img src="{{ asset('assets/backend/assets/images/flags/germany.jpg') }}" alt="user-image"
                                    class="me-1" height="12"> <span class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                                <img src="{{ asset('assets/backend/assets/images/flags/italy.jpg') }}" alt="user-image"
                                    class="me-1" height="12"> <span class="align-middle">Italian</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                                <img src="{{ asset('assets/backend/assets/images/flags/russia.jpg') }}" alt="user-image"
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <div class="px-lg-2">
                                <div class="row g-0">
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/backend/assets/images/brands/github.png') }}" alt="Github">
                                            <span>GitHub</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/backend/assets/images/brands/bitbucket.png') }}"
                                                alt="bitbucket">
                                            <span>Bitbucket</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/backend/assets/images/brands/dribbble.png') }}"
                                                alt="dribbble">
                                            <span>Dribbble</span>
                                        </a>
                                    </div>
                                ...
                                <div class="row g-0">
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/backend/assets/images/brands/dropbox.png') }}"
                                                alt="dropbox">
                                            <span>Dropbox</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/backend/assets/images/brands/mail_chimp.png') }}"
                                                alt="mail_chimp">
                                    ...
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/backend/assets/images/brands/slack.png') }}" alt="slack">
                                            <span>Slack</span>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                            ...
                            <div data-simplebar style="max-height: 230px;">
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        <img src="{{ asset('assets/backend/assets/images/users/avatar-3.jpg') }}"
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        <img src="{{ asset('assets/backend/assets/images/users/avatar-4.jpg') }}"
                                            class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="{{ asset('/assets/images/logo.jpeg') }}" alt="Header Avatar">
