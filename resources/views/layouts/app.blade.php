...
<head>
    ...
    <!-- nivo slider CSS -->
    <link rel="stylesheet" href="{{ asset('assets/frontend/inc/custom-slider/css/nivo-slider.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('assets/frontend/inc/custom-slider/css/preview.css')}}" type="text/css" media="screen" />
    <!-- style css -->
...
<body class="home">
                        ...
                        <div class="ticker-wrap">
                            ...
                            <div class="tickers col-md-10">
                                <div id="top-news-slider" class="owl-carousel ">
                                    <div class="item">
                                        <a href="blog-single.html"> <img src="{{ asset('assets/frontend/images/breaking/1.jpg')}}" alt="news image"> <span>Migrants Told: Stay in France </span></a>
                                    </div>
                                    <div class="item">
                                        <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/breaking/2.jpg')}}" alt="news image"> <span>Duo Scripta An The Prieirmod</span></a>
                                    </div>
                                    <div class="item">
                                        <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/breaking/3.jpg')}}" alt="news image"> <span>Two Loser Idaho Pot Smugglers </span></a>
                                    </div>
                                    <div class="item">
                                        <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/breaking/4.jpg')}}" alt="news image"> <span>Car racer gives herself a mid-Event</span></a>
                                    </div>
                                    <div class="item">
                                        <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/breaking/5.jpg')}}" alt="news image"> <span>Aaron Rodgers Criticizes </span></a>
                                    </div>
                                    <div class="item">
                                        <a href="blog-single.html"> <img src="{{ asset('assets/frontend/images/breaking/1.jpg')}}" alt="news image"> <span>Detroit Natives Wary & Recovery</span></a>
                                    </div>
                                    <div class="item">
                                        <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/breaking/4.jpg')}}" alt="news image"> <span>Clinton campaign jilted as FBI</span></a>
                                    </div>                             
                               </div>
                           </div>
                        </div>
                ...
                <div class="slider-area">
                    <div class="bend niceties preview-2">
                        <div id="ensign-nivoslider" class="slides">
                            <img src="{{ asset('assets/frontend/images/slider/slide_1.jpg')}}" alt="" title="#slider-direction-1" />
                            <img src="{{ asset('assets/frontend/images/slider/slide_3.jpg')}}" alt="" title="#slider-direction-2" />
                        </div>
                        <!-- direction 2 -->
                    ...
                    <div class="tab-content">
                        <div id="tab1" class="tab-pane fade in active">
                            <div class="tab-top-content">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 paddimg-right-none">
                                        <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/tab/1.jpg')}}" alt="sidebar image"></a>
                                    </div>
                            ...
                            <div class="tab-bottom-content">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 tab-area">
                                        <div class="col-sm-12 col-xs-3 img-tab">
                                            <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/tab/3.jpg')}}" alt="News image"></a>
                                        </div>
                                        <div class="col-sm-12 col-xs-9 img-content">
                                            <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"> </i>June 28, 2017</span>
                                            <h4><a href="blog-single.html">The Soccer Field Close.</a></h4>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 tab-area">
                                        <div class="col-sm-12 col-xs-3 img-tab">
                                            <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/tab/4.jpg')}}" alt="News image"></a>
                                        </div>
                                        <div class="col-sm-12 col-xs-9 img-content">
                                            <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"> </i>June 28, 2017</span>
                                            <h4><a href="blog-single.html">The Soccer Field Close.</a></h4>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 tab-area">
                                        <div class="col-sm-12 col-xs-3 img-tab">
                                            <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/tab/5.jpg')}}" alt="News image"></a>
                                        </div>
                                        <div class="col-sm-12 col-xs-9 img-content">
                                            <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"> </i>June 28, 2017</span>
                                            <h4><a href="blog-single.html">The Soccer Field Close.</a></h4>
                        ...
                        <div id="tab2" class="tab-pane fade">
                            <div class="tab-top-content">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 paddimg-right-none">
                                        <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/tab/7.jpg')}}" alt="sidebar image"></a>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 last-col">
                                      	<span class="date"><a href="#"><i class="fa fa-user-o" aria-hidden="true"></i> james Bond </a></span> <span class="comment"><a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i> 50</a></span>
                                        <h3><a href="#">Migrants Told: Stay in France or go back to your country</a></h3>
                            ...
                            <div class="tab-bottom-content">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 tab-area">
                                        <div class="col-sm-12 col-xs-3 img-tab">
                                            <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/tab/2.jpg')}}" alt="News image"></a>
                                        </div>
                                        <div class="col-sm-12 col-xs-9 img-content">
                                            <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> June 28, 2017</span>
                        ...
                        <div id="tab3" class="tab-pane fade">
                            <div class="tab-top-content">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 paddimg-right-none">
                                        <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/tab/8.jpg')}}" alt="sidebar image"></a>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 last-col">
                                        <span class="date"><a href="#"><i class="fa fa-user-o" aria-hidden="true"></i> james Bond </a></span> <span class="comment"><a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i> 50</a></span>
                                        <h3><a href="#">Migrants Told: Stay in France or go back to your country</a></h3>
                    ...
                    <div class="trending-news separator-large">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="list-col">
                                    <a href="blog-single.html"> <img src="{{ asset('assets/frontend/images/Trending/1.jpg')}}" alt="" title="Trending image" /></a>
                                    <div class="dsc">
                                                ...
                                                <div class="item-post">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-3 paddimg-right-none">
                                                            <a href="blog-single.html"> <img src="{{ asset('assets/frontend/images/Trending/2.jpg')}}" alt="" title="Trending image"></a>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 content">
                                                <div class="item-post">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-3 paddimg-right-none">
                                                            <a href="blog-single.html"> <img src="{{ asset('assets/frontend/images/Trending/3.jpg')}}" alt="" title="Trending image"></a>
                                                        </div>
                                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-9">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 content">
                                                <div class="item-post">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-3 paddimg-right-none">
                                                            <a href="blog-single.html"> <img src="{{ asset('assets/frontend/images/Trending/4.jpg')}}" alt="" title="Trending image"></a>
                                                        </div>
                                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-9">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 content">
                                                <div class="item-post">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-3 paddimg-right-none">
                                                            <a href="blog-single.html"> <img src="{{ asset('assets/frontend/images/Trending/5.jpg')}}" alt="" title="Trending image"></a>
                                                        </div>
                                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-9">
                    ...
                    <div class="hot-news">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="featured">
                                    <div class="blog-img">
                                        <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/hot-news/1.jpg')}}" alt="" title="News image" /></a>
                                    </div>
                                ...
                                <ul class="news-post news-feature-mb">
                                    <li>
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4">
                                                <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/hot-news/3.jpg')}}" alt="News image" /></a>
                                            </div>
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4">
                                                <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/hot-news/2.jpg')}}" alt="News image" /></a>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-8 content">
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4">
                                                <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/hot-news/4.jpg')}}" alt="News image" /></a>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-8 content">
                    ...
                    <div class="sidebar popular">
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="post-image"><img src="{{ asset('assets/frontend/images/sidebar/1.jpg')}}" alt="News image"></div>
                                <div class="content">
                                    <h4>
                                        ...
                                        <div class="item-post">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-3 paddimg-right-none">
                                                    <img src="{{ asset('assets/frontend/images/popular/1.jpg')}}" alt="" title="News image">
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 content">
                                        <div class="item-post">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-3 paddimg-right-none">
                                                    <img src="{{ asset('assets/frontend/images/popular/2.jpg')}}" alt="" title="News image">
                                                </div>
                                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-9">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 content">
                                        <div class="item-post">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-3 paddimg-right-none">
                                                    <img src="{{ asset('assets/frontend/images/popular/3.jpg')}}" alt="" title="News image">
                                                </div>
                                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-9">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 content">
                                        <div class="item-post">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-3 paddimg-right-none">
                                                    <img src="{{ asset('assets/frontend/images/popular/4.jpg')}}" alt="" title="News image">
                                                </div>
                                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-9">
                                                    <h4><a href="blog-single.html"> Erant Aeque Neius No <br />Numes Electram</a></h4>
                                                    <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> June 28, 2017</span>                                                
                    ...
                    <div id="featured-videos-section" class="owl-carousel">
					    <div class="item">
							<div class="single-videos">
								<div class="images">
									<a href="#"><img src="{{ asset('assets/frontend/images/fetuered/1.jpg')}}" alt=""></a>
									<div class="overley">
										<div class="videos-icon">
											<a class="popup-videos" href="http://www.youtube.com/watch?v=Cdajfy4voyY"><img src="{{ asset('assets/frontend/images/fetuered/video-icon.png')}}" alt=""></a>                           
										</div>
									</div>
								</div>                            
						...
						<div class="item">
							<div class="single-videos">
								<div class="images">
									<a href="#"><img src="{{ asset('assets/frontend/images/fetuered/2.jpg')}}" alt=""></a>
									<div class="overley">
										<div class="videos-icon">
											<a class="popup-videos" href="http://www.youtube.com/watch?v=Cdajfy4voyY"><img src="{{ asset('assets/frontend/images/fetuered/video-icon.png')}}" alt=""></a>                      
										</div>
						...
						<div class="item">
							<div class="single-videos">
								<div class="images">
									<a href="#"><img src="{{ asset('assets/frontend/images/fetuered/3.jpg')}}" alt=""></a>
									<div class="overley">
										<div class="videos-icon">
											<a class="popup-videos" href="http://www.youtube.com/watch?v=Cdajfy4voyY"><img src="{{ asset('assets/frontend/images/fetuered/video-icon.png')}}" alt=""></a>                      
										</div>
						...
						<div class="item">
							<div class="single-videos">
								<div class="images">
									<a href="#"><img src="{{ asset('assets/frontend/images/fetuered/4.jpg')}}" alt=""></a>
									<div class="overley">
										<div class="videos-icon">
											<a class="popup-videos" href="http://www.youtube.com/watch?v=Cdajfy4voyY"><img src="{{ asset('assets/frontend/images/fetuered/video-icon.png')}}" alt=""></a>                  
										</div>
						...
						<div class="item">
							<div class="single-videos">
								<div class="images">
									<a href="#"><img src="{{ asset('assets/frontend/images/fetuered/5.jpg')}}" alt=""></a>
									<div class="overley">
										<div class="videos-icon">
											<a class="popup-videos" href="http://www.youtube.com/watch?v=Cdajfy4voyY"><img src="{{ asset('assets/frontend/images/fetuered/video-icon.png')}}" alt=""></a>                  
										</div>
                    ...
                    <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div id="news-Carousel" class="carousel carousel-news slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <a href="#"><img src="{{ asset('assets/frontend/images/news-slider-image/1.jpg')}}" alt="" title="#slider-direction-1" /></a>
                                            <div class="dsc">
                                                <span class="date">
                                        ...
                                        <div class="item">
                                            <a href="#"><img src="{{ asset('assets/frontend/images/news-slider-image/3.jpg')}}" alt="" title="#slider-direction-1" /></a>
                                            <div class="dsc">
                                                <span class="date">
                                                    <i class="fa fa-calendar-check-o" aria-hidden="true"></i> November 28, 2017 
                                                </span>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div id="news-Carousel2" class="carousel carousel-news slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <a href="#"><img src="{{ asset('assets/frontend/images/news-slider-image/2.jpg')}}" alt="" title="#slider-direction-1" /></a>
                                            <div class="dsc">
                                                <span class="date">
                                                    <i class="fa fa-calendar-check-o" aria-hidden="true"></i>
                                                    November 28, 2017 
                                        ...
                                        <div class="item">
                                            <a href="#"><img src="{{ asset('assets/frontend/images/news-slider-image/4.jpg')}}" alt="" title="#slider-direction-1" /></a>
                                            <div class="dsc">
                                                <span class="date">
                                                <i class="fa fa-calendar-check-o" aria-hidden="true"></i>
                        ...
                        <li>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content">
                                    <div class="item-post">
                                        ...
                                        <div class="blog-image">
                                            <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/world/5.jpg')}}" alt="" title="News image" /></a>
                                        </div>
                                        <div class="content">
                                           <span class="date">
                                                <i class="fa fa-calendar-check-o" aria-hidden="true"></i>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content">
                                    <div class="item-post">
                                        <div class="blog-image">
                                            <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/world/6.jpg')}}" alt="" title="News image" /></a>
                                        </div>
                                        <div class="content">
                                            <span class="date">
                                                <i class="fa fa-calendar-check-o" aria-hidden="true"></i>
                            ...
                            <div class="row">
                                    ...
                                    <div class="item-post">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-3 paddimg-right-none">
                                                <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/world/1.jpg')}}" alt="" title="News image" /></a>
                                            </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 content">
                                    <div class="item-post">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-3 paddimg-right-none">
                                                <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/world/2.jpg')}}" alt="" title="News image" /></a>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-9">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 content">
                                    <div class="item-post">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-3 paddimg-right-none">
                                                <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/world/3.jpg')}}" alt="" title="News image" /></a>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-9">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 content">
                                    <div class="item-post">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-3 paddimg-right-none">
                                                <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/world/4.jpg')}}" alt="" title="News image" /></a>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-9">
                    ...
                    <div class="sidebar">
                        <ul>
                            <li>
                                ...
                                <div class="post-image"><a href="blog-single.html"><img src="{{ asset('assets/frontend/images/sidebar/1.jpg')}}" alt="News image" /></a></div>
                                <div class="content">
                            ...
                            <li>
                                ...
                                <div class="post-image"><a href="blog-single.html"><img src="{{ asset('assets/frontend/images/sidebar/2.jpg')}}" alt="News image" /></a></div>
                                <div class="content">
                            ...
                            <li>
                                ...
                                <div class="post-image"><a href="blog-single.html"><img src="{{ asset('assets/frontend/images/sidebar/3.jpg')}}" alt="News image" /></a></div>
                                <div class="content">
                                    <h4><a href="#">The exhibition Bankasy doesn’t want you to see</a></h4>
                                    <span class="date"> 
                                        <i class="fa fa-calendar-check-o" aria-hidden="true"></i> November 28, 2017 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="single-footer footer-one">
                            <h3>About</h3>
                            <div class="footer-logo"><img src="{{ asset('assets/frontend/images/footer-logo.png')}}" alt="footer-logo"></div>
                                ...
                                <ul>
                                    <li>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
                                            <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/post-images/post-1.jpg')}}" alt="post photo"></a>
                                        </div>
                                    ...
                                    <li>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
                                            <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/post-images/post-2.jpg')}}" alt="post photo"></a>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-8">
                                            <p><a href="blog-single.html">US should prepare for Russian election</a></p>
                                            <span><i class="fa fa-calendar-check-o" aria-hidden="true"> </i> June  28,  2017</span>
                                    ...
                                    <li>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
                                            <a href="blog-single.html"><img src="{{ asset('assets/frontend/images/post-images/post-3.jpg')}}" alt="post photo"></a>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-8">
                                            <p><a href="blog-single.html">US should prepare for Russian election</a></p>
                                            <span><i class="fa fa-calendar-check-o" aria-hidden="true"> </i> June  28,  2017</span>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="single-footer footer-three">
                            ...
                            <ul>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/1.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/2.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/3.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/4.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/5.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/6.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/7.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/8.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/9.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/10.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/11.png')}}" alt="flicker photo"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('assets/frontend/images/flicker/12.png')}}" alt="flicker photo"></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <!-- Nivo slider js -->
    <script src="{{ asset('assets/frontend/inc/custom-slider/js/jquery.nivo.slider.js')}}" type="text/javascript"></script>
